...
class PlaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JooksWebServiceBundle:Place')->findAll();
     ...
     * @Method("POST")
     * @Template("JooksWebServiceBundle:Place:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JooksWebServiceBundle:Place')->find($id);
     ...
     * @Method("PUT")
     * @Template("JooksWebServiceBundle:Place:edit.html.twig")
     */
